 ...
 * the License.
 */
package com.liudao51.datacenter.common.mybatisplus.generator.config.builder;
...
import com.liudao51.datacenter.common.mybatisplus.generator.config.po.TableField;
import com.liudao51.datacenter.common.mybatisplus.generator.config.po.TableFill;
...
public class ConfigBuilder {
    ...
    private String superControllerImplClass;
    /**
     * 数据库表信息
     */
    ...
    public String getSuperControllerImplClass() {
        return superControllerImplClass;
    }
    ...
    private void handlerPackage(TemplateConfig template, String outputDir, PackageConfig config) {
        ...
        packageInfo.put(ConstVal.CONTROLLER_IMPL, joinPackage(config.getParent(), config.getControllerImpl()));
        ...
        if (null != configPathInfo) {
            ...
            setPathInfo(pathInfo, template.getControllerImpl(), outputDir, ConstVal.CONTROLLER_IMPL_PATH, ConstVal.CONTROLLER_IMPL);
        }
    }
    ...
    private void processTypes(StrategyConfig config) {
        ...
        if (StringUtils.isEmpty(config.getSuperControllerImplClass())) {
            superControllerImplClass = ConstVal.SUPER_CONTROLLER_IMPL_CLASS;
        } else {
            superControllerImplClass = config.getSuperControllerImplClass();
        }
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (StringUtils.isNotEmpty(globalConfig.getControllerName())) {
                ...
                tableInfo.setControllerName("I" + entityName + ConstVal.CONTROLLER);
            }
            if (StringUtils.isNotEmpty(globalConfig.getControllerImplName())) {
                tableInfo.setControllerImplName(String.format(globalConfig.getControllerImplName(), entityName));
            } else {
                tableInfo.setControllerImplName(entityName + ConstVal.CONTROLLER_IMPL);
            }

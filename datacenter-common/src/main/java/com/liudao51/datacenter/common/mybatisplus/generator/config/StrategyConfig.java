...
public class StrategyConfig {
     ...
     * 自定义继承的Dao类全称，带包名
     */
    private String superDaoClass = ConstVal.SUPER_DAO_CLASS;

    /**
     * 自定义继承的DaoImpl类全称，带包名
     */
    private String superDaoImplClass = ConstVal.SUPER_DAO_IMPL_CLASS;
     ...
     */
    private String superControllerClass = ConstVal.SUPER_CONTROLLER_CLASS;

    /**
     * 自定义继承的ControllerImpl类全称，带包名
     */
    private String superControllerImplClass = ConstVal.SUPER_CONTROLLER_IMPL_CLASS;
    ...
    public StrategyConfig setSuperDaoImplClass(String superDaoImplClass) {
    ...
    public StrategyConfig setSuperControllerImplClass(String superControllerImplClass) {
        this.superControllerImplClass = superControllerImplClass;
        return this;
    }

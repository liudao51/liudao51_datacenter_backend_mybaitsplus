 ...
 * the License.
 */
package com.liudao51.datacenter.common.mybatisplus.generator.engine;
...
import com.liudao51.datacenter.common.mybatisplus.generator.config.ConstVal;
import com.liudao51.datacenter.common.mybatisplus.generator.config.FileOutConfig;
import com.liudao51.datacenter.common.mybatisplus.generator.config.GlobalConfig;
import com.liudao51.datacenter.common.mybatisplus.generator.config.TemplateConfig;
...
import com.liudao51.datacenter.common.mybatisplus.generator.config.rules.FileType;
...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // MpDaoImpl.java
                if (null != tableInfo.getDaoImplName() && null != pathInfo.get(ConstVal.DAO_IMPL_PATH)) {
                    String daoImplFile = String.format((pathInfo.get(ConstVal.DAO_IMPL_PATH) + File.separator + tableInfo.getDaoImplName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.DAO_IMPL, daoImplFile)) {
                ...
                // MpControllerImpl.java
                if (null != tableInfo.getControllerImplName() && null != pathInfo.get(ConstVal.CONTROLLER_IMPL_PATH)) {
                    String controllerImplFile = String.format((pathInfo.get(ConstVal.CONTROLLER_IMPL_PATH) + File.separator + tableInfo.getControllerImplName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.CONTROLLER_IMPL, controllerImplFile)) {
                        writer(objectMap, templateFilePath(template.getControllerImpl()), controllerImplFile);
                    }
                }
            }
        } catch (Exception e) {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        objectMap.put("superControllerImplClassPackage", config.getSuperControllerImplClass());
        objectMap.put("superControllerImplClass", getSuperClassName(config.getSuperControllerImplClass()));
        return objectMap;
    }
